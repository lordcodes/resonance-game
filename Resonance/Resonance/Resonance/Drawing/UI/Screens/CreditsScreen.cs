...
namespace Resonance
{
    class CreditsScreen : Screen
    {
        ...
        public override void LoadContent() 
        {
            ...
            images.Add(ScreenManager.Content.Load<Texture2D>("Drawing/UI/Credits/pickup_render"));
            ...
            images.Add(ScreenManager.Content.Load<Texture2D>("Drawing/UI/Credits/logo_render"));
