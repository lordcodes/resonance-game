...
namespace Resonance
{
    class FreezeBar : PickupBar
    {
        public FreezeBar(GraphicsDeviceManager graphics)
            :base(graphics)
        {            
        }
        ...
        {
            HUDTextureBare = content.Load<Texture2D>("Drawing/HUD/Textures/pickupemptyb");
            HUDTextureFull = content.Load<Texture2D>("Drawing/HUD/Textures/pickupfullb");
